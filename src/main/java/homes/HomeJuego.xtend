...
class HomeJuego {
	...
	new() {
		...
		amumu = new Personaje(1,"Amumu",	#["Araniar", "Llorar!", "Araniar", "Llorar!", "Araniar", "Llorar!","Araniar", "Llorar!", "Araniar", "Llorar!", "Araniar", "Llorar!","Araniar", "Llorar!", "Araniar", "Llorar!"],#["La ducha",'colgar la ropa'], top,'assets/images/amumu.png')
